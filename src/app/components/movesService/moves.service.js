(function () {
    ...
    movesService.$inject = ["alliesService", "enemiesService", "fightLogService", "$timeout", "statusEffectsService", "boardManager", "gameStatsService"];

    function movesService(alliesService, enemiesService, fightLogService, $timeout, statusEffectsService, boardManager, gameStatsService) {
        var svc = this;
        ...
        function enemyAttackAlly(enemy, target) {
            ...
            if ((Math.random() * 6 * enemy.stats.speed) > (Math.random() * target.stats.speed)) {
                ...
                gameStatsService.allyReceivedDamage(damage, target);
        ...
        function lastDance(enemy, ally) {
            enemiesService.deliverRegularDamage(enemy, ally.stats.speed, ally);
