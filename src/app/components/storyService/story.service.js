        ...
        vm.storyTexts = [
            ...
            [
                ...
                [
                    ...
                    "I went everywhere with D. She was studying at Emerald U, biology or mechanical engineering, the" +
                    " classes may as well have been taught in French. It was a pretty good gig. They were paying me" +
                    " more than Damien was and I wasn't really doing anything but scaring all of D's classmates. My" +
                    " hands were even starting to heal.",
            ...
            [
                ["Shook Up"],
                [
                    "Frank came over immediately with his entourage. It was the first time I'd met him. He didn't" +
                    " talk to me much.",
                    "D kept insisting that they were sent by a guy by the name of Alex Wright. Someone high up in" +
                    " the organization who was eyeing Frank's throne. Frank wrote it off as a random burglary. I'll" +
                    " admit, it didn't seem likely in this part of town, but my job was to be seen and not heard.",
                    "Frank spent the night in the lobby of the apartment with a couple of his guys. D couldn't" +
                    " sleep, she kept pacing back and forth in the kitchen.",
                    ...
                    ". . .",
                    "I knew it was a bad idea, but my life depended on staying in D's good graces not Frank's, and" +
                    " what did I know about good ideas?",
                    "We pulled up in front of a nightclub. Alex was inside.",
                    "'Wait here.'",
                    "I walked toward the front door of the club. I knew the bouncer. He had fought at Damien's for a" +
                    " while.",
                    ...
                    "I looked back at the car. D was standing outside with a gun pointed across the parking lot. I" +
                    " followed her aim to what must have been Alex with a posse surrounding him. I pulled my gun and" +
                    " rushed towards them..."
                ]
            ],
            [
                ...
                [
                    ...
                    "He admitted to sending the men to her place. He'd sent men after Frank that night too, they" +
                    " hadn't made it very far, but Frank hid that from D. It was getting worse than he had led her" +
                    " to believe. The entire Outer Zone which was already in disarray was heading for collapse.",
                    "We got in the car and took off just before the police arrived.",
                    "If I could have predicted the chain reaction that night set into motion, I could have saved" +
                    " myself a lot of trouble.",
                    "Tim Woodman, the Baumville PD Captain, got on the news the next morning and set forth his plan" +
                    " to clean up the Outer Zone.",
                    "Less than 24 hours later, Frank Taylor was killed. There was surveillance footage of the" +
                    " shooting. A man covered head to toe in some kind of metallic suit. People called him 'The Tin" +
                    " Man'. Some people thought it was Frank Keller in a suit he'd designed in the Singularity labs." +
                    " There didn't seem to be a lot of investigation.",
                    "D was understandably upset, but she knew the nature of Frank's work and that it was more of a" +
                    " when than if. When Frank's accounts were frozen, the trusts he'd set up for D were frozen as" +
                    " well. Her tuition checks bounced and she was forcibly un-enrolled at Emerald U. The" +
                    " university, city and banks were all unsympathetic when they learned where the money had been" +
                    " coming from. Frank owned the apartment complex she was living in and fortunately they couldn't" +
                    " evict her without evicting all the tenants, but nevertheless there was a target on her back.",
                    "It wasn't hard to find dirty cash in every nook and cranny that Frank touched, so my paycheck" +
                    " never stopped coming, but with Frank out of the picture, I started to worry about Damien. I" +
                    " explained it to D. I couldn't watch her back when I was always looking over my own shoulder.",
            ...
            [
                ...
                [
                    ...
                    "They all fought for Damien. He was the only thing keeping a bunch of goons like us alive in" +
                    " Baumville.",
                    "Even if I was going to die in this warehouse, it felt good to finally be going against his" +
                    " wishes.",
                    "Then some of them started backing away. Some were even pulling guys off of D and I.",
                    "Eventually it was just me, Damien and Nix. Nix was the only guy at Damien's that I'd never" +
                    " beaten in the pit. He could be any kind of fighter he wanted. If his opponent came out strong," +
                    " he let them tire out, if they played defense he would pummel them until they broke.",
                    "He was Damien's favorite. He only fought when he wanted and who he wanted. Each time we'd gone" +
                    " into the pit it had been days after my previous fight and a month since his. Not that anyone" +
                    " was really keeping track of the wins. It was just bloodsport."
                ]
            ],
            [
                ["Occupy"],
                [
                    "With Damien out of the way, D shifted her focus. She wanted to reclaim the Outer Zone. The" +
                    " Baumville PD had installed a small army in the area. Anyone who began to emerge as a leader" +
                    " was promptly shipped to a prison in the middle of the city. Their strategy was to maintain" +
                    " chaos as long as possible so that the inhabitants would weaken themselves, then come in and" +
                    " pick up the pieces.",
                    "D had met with the few people she felt she could still trust. Most of them were laying low," +
                    " some had left the city entirely. They laid out a plan and the first step was to drive out the" +
                    " police occupation.",
                    ""
                ]
            ]
